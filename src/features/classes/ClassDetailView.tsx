  ...
  return (
    <div className="flex flex-col h-full space-y-6">
      ...
      <div className="flex items-center gap-4 border-b border-slate-200 pb-4 shrink-0">
        ...
        <div>
          <h2 className="text-2xl font-bold text-slate-800">{liveClass.name}</h2>
          <p className="text-slate-500">{liveClass.subject} • {liveClass.studentIds.length} Students</p>
        </div>
      </div>

      {/* Tabs */}
      <div className="flex gap-1 bg-slate-100 p-1 rounded-lg w-fit shrink-0 overflow-x-auto">
        <button
